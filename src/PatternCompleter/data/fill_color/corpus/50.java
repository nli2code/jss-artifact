...
public class StateStockPerformanceDashboardExcelGen extends AbstractExcelView {

	@Override
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request,
			HttpServletResponse respones) throws Exception {
		try {
			JSONArray data = (JSONArray) model.get("stockPerfoarmanceData");
			...
			for (i = 0; i < data.length(); i++) {
				...
				HSSFCellStyle lgaStyle=workbook.createCellStyle();
				ExcelStyle.setBorderStyle(lgaStyle);
				HSSFFont font=workbook.createFont();
				font.setBoldweight(Font.BOLDWEIGHT_BOLD);
				lgaStyle.setFont(font);
				cell.setCellStyle(lgaStyle);
					...
					ExcelStyle.setBorderStyle(style);
					...
					if(count==1){
						...
						ExcelStyle.setBorderStyle(style1);
						ExcelStyle.setBorderStyle(style2);
						if(!String.valueOf(rowObject.get("GREATER_2_ANTIGENS_TOTAL_HF_PER")).equals("0")
						...
						ExcelStyle.setBorderStyle(style3);
