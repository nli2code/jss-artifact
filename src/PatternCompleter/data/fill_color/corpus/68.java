...
public class LgaStockPerformanceExelGen extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model, 
		...
		try {
			List<LabelValueBean> productlist=(List<LabelValueBean>) model.get("productlistwithstatename");
				...
				for (LabelValueBean product : productlist) {
			    	...
			    	while(keys.hasNext()){
			    		...
			    		if(key.contains(product.getLabel())){
			    			...
			    			cell1.setCellValue((int)Double.parseDouble(obj.getString(product.getLabel())));
...
//				    String key = (String)keys.next();
//				    if ( rowObject.get(key) instanceof JSONObject ) {
//				    	JSONObject obj=rowObject.getJSONObject(key);
//				    	Iterator<?> keys1 = obj.keys();
//				    	while(keys1.hasNext()){
//				    		String innerkey=(String)keys1.next();
//				    		if(innerkey.equals("LEGEND_COLOR")){
//				    			HSSFCellStyle cellStyle = workbook.createCellStyle();
//						    	switch (obj.getString("LEGEND_COLOR")) {
//								case "#00B050": // for green
...
//								}
//				    		}else{
//				    			cell.setCellValue(obj.getString(innerkey));
//				    		}
//				    	}
//				    }else{
